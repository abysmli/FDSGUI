package com.fds.gui.views;

import com.fds.gui.MainApp;
import com.fds.gui.controllers.*;
import com.fds.gui.models.Component_List;
import com.fds.gui.models.Fault_List;
import com.fds.gui.models.Function_List;
import com.fds.gui.models.Mainfunction_List;
import com.fds.gui.models.Subfunction_List;
import com.fds.gui.models.Subsystem_List;
...
public class FDSMainGUIController implements Initializable {
...
//	private TableColumn<Map, String> unknownFaultType, unknownFaultDesc, unknownSolution;
	...
	private FDSCenterController centerController;
	 ...
	 * method.
	 */
	public FDSMainGUIController() {

	}

	public void startApp(MainApp mainApp) throws JSONException, Exception {
		setApplication(mainApp);
		centerController = new FDSCenterController(this, graphicCanvas, canvas_panel, components_model_panel,
	...
	public void initialize(URL location, ResourceBundle resources) {
		try {
			initModelTables();
			FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/FDSRunningLog.fxml"));
