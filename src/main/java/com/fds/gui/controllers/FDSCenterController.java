...
public class FDSCenterController {

	private FDSHttpRequestHandler http = new FDSHttpRequestHandler(FDSGUISetting.FDSAddress);
	...
	public FDSCenterController(FDSMainGUIController fds_gui, Canvas graphic_canvas, AnchorPane canvas_panel,
